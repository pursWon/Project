...
struct StoryBrain {
    ...
    WolfStory(story: "나무 뒤에서 음흉하게 웃고 있는 늑대를 만났습니다", choice1Destination: 0, choice2Destination: 0),
        
    WolfStory(story: "두 갈래 길이 나왔습니다. 어느 쪽으로 가시겠습니까?", choice1: "왼쪽", choice2: "오른쪽", choice1Destination: 5, choice2Destination: 14),
        
    WolfStory(story: "다시 두 갈래 길이 나왔습니다. 어느 쪽으로 가시겠습니까?", choice1: "노랫소리가 들려오는 곳", choice2: "늑대소리가 들려오는 곳", choice1Destination: 6, choice2Destination: 7),
        
    WolfStory(story: "노래를 부르며 놀던 늑대에게 물려서 사망하였습니다"),
        
    WolfStory(story: "과일을 팔고 있는 늑대를 만났습니다. 과일을 사시겠습니까?", choice1: "사..사겠습니다", choice2: "아니요 !!!!", choice1Destination: 8, choice2Destination: 10),
        
    WolfStory(story: "과일을 파는 늑대의 호위를 받아 무사히 집앞에 도착하였습니다.", choice1: "늑대님, 감사합니다", choice2: "이만 가보겠습니다. 감사합니다 늑대님", choice1Destination: 9, choice2Destination: 9),
        
    WolfStory(story: "저런.. 늑대를 끝까지 믿으셨군요. 당신은 저녁 메뉴가 되었습니다."),
    ...
    WolfStory(story: "어리석게도 뛰다가 당신은 넘어졌습니다. 늑대의 굿디너가 되었습니다."),
    
    WolfStory(story: "무사히 과일가게에 도착하였습니다.", choice1: "처음으로", choice2: "돌아가기", choice1Destination: 0, choice2Destination: 0),
        
    WolfStory(story: "과일가게 근처에 다다른 당신은 목이 마르던 찰나에 수상쩍은 우물을 발견했습니다. 물을 드시겠습니까?", choice1: "물을 먹자", choice2: "물이 상했을 수도 있다 먹지 말자" , choice1Destination: 16, choice2Destination: 15),
    
    WolfStory(story: "몸의 필수요소인 물을 소중히 하지 않은 당신에게 화가 난 늑대가 당신을 잡아먹었습니다"),
