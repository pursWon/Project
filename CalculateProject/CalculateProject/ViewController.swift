...
class ViewController: UIViewController {
    ...
    @IBAction func calculateButton(_ sender: UIButton) {
        ...
        // if let을 통해 number1을 안전하게 가져와서 firstNumber라는 상수에 담아준다.
        // if let을 통해 number2도 안전하게 가져와서 secondNumber라는 상수에 담아준다.
        // 안전하게 가져오는 것을 성공한 경우, 계산하는 코드를 넣어준다.
        // 안전하게 가져오는 것을 실패한 경우, 계산 대신에 "이곳엔 문자를 넣을 수 없습니다." 라고 resultLabel.text에 대입해준다.
        if let firstNumber = number1, let secondNumber = number2 {
